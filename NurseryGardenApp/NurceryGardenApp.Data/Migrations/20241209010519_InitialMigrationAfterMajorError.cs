...
{
    /// <inheritdoc />
    public partial class InitialMigrationAfterMajorError : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 25.00m, new DateTime(2025, 12, 9, 0, 0, 0, 0, DateTimeKind.Local), "25 percent discount", new DateTime(2024, 12, 9, 0, 0, 0, 0, DateTimeKind.Local) },
                    { 2, 10.00m, new DateTime(2025, 12, 9, 0, 0, 0, 0, DateTimeKind.Local), "10 percent discount", new DateTime(2024, 12, 9, 0, 0, 0, 0, DateTimeKind.Local) }
                });
